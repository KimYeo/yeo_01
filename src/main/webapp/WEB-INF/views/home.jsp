...
<html>
	...
	<body class="is-preload">
									...
									<!-- Mini Post -->
										<article class="mini-post">
											<header>
												...
												<a href="#" class="author"><img src="/resources/images/babyapeach_1.jpg" alt="" /></a>
											</header>
		...
		<!-- Scripts -->
			...
			<script  type="text/javascript" src="/resources/assets/js/browser.min.js"></script>
			<script  type="text/javascript" src="/resources/assets/js/breakpoints.min.js"></script>
