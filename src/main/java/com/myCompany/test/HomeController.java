...
import com.myCompany.test.util.MediaUtils;
import com.myCompany.test.util.UploadFileUtils;
...
public class HomeController {
	...
	@RequestMapping(value = "/fileUpSample", method = RequestMethod.GET)
	public String sample(Locale locale, Model model) {
		logger.info(" @@@ [/fileUpSample] @@@");
